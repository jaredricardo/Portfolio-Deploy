            ...
            <div className="portfolio" id="portfolio">
                <Row className="row-height-set-100-2">
                    ...
                    <span id="portfolio-jared"> 
                        My recent projects include creating a <a class="color-links" href={'https://jaredricardo.github.io/Stock-Screener-Deploy/'} target="_blank">financial dashboard</a>,
                        ...
                        target="_blank">a pixel sorting application</a>, and building full stack e-commerce solutions for
                            <a class="color-links" target="_blank" href={'https://myobvi.com/'}> Obvi</a>,
                            &nbsp;
                            <a class="color-links" target="_blank" href={'https://310nutrition.com/'}>310 Nutrition</a>,
                            &nbsp;
                            <a class="color-links" target="_blank" href={'https://lunarsolargroup.com/'}> Lunar Solar Group</a>,
                            &nbsp;
                            and
                            &nbsp;
                            <a class="color-links" target="_blank" href={'https://trueclassic.com/'}> True Classic Tees</a>.
                    </span> 
                    </Col>
